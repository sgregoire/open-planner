...
import { betweenCheck, colorChecker, eventTypeChecker, nonEmptyString, occurenceChecker, reduceCheckResults, rootChecker, timeChecker, timeframeChecker } from "../../src/lib/checkers";
import { Day, type Color, type EventType, type Hour, type Minute, type Occurence, type Root, type Time, type Timeframe } from "../../src/model";
